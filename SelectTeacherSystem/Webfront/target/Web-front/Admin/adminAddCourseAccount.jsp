                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active panel panel-default dropdown">
                            ...
                            <div id="dropdown-form" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <ul class="nav navbar-nav">
                                        <li><a href="/Admin/adminAddCourseAccount">添加课题</a>
                                        </li>
        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    <span class="title">添加课题信息</span>
                    <div class="description">添加课题</div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    <div class="title">添加课题</div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form class="form-horizontal" action="/HaveClass/saveCourse" method="post" id="Register" >
                                    <div class="form-group">
                                        <label for="courseName">课题名称</label>
                                        <input type="text" class="form-control" id="courseName" name="courseName"  placeholder="写入课题的名称...">
                                    </div>
                                    <div class="form-group">
                                        <label for="courseTeachername">指导教师</label>
                                        <input type="text" class="form-control" id="courseTeachername" name="courseTeachername" placeholder="写入课题教师的姓名..." onblur="LoginCheck4()">
                                        <span id="courseTeachernameCheck" style="..."></span>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div>
                                        <select name="courseApplytime" id="courseApplytime">
                                            <optgroup label="课题来源">
                                                <option value="生产实际">生产实际</option>
                                                <option value="科研项目"  >科研项目</option>
                                                <option value="虚拟课题" >虚拟课题</option>
                                                <option value="实际课题"  >实际课题</option>
                                            </optgroup>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" class="btn btn-default" >添加课题</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
