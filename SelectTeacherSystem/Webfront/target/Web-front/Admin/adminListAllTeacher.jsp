        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    ...
                    <div class="description">查看所有教师信息</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                                ...
                                <table class="datatable table table-striped" cellspacing="0" width="100%">
                                    ...
                                    <c:forEach items="${teacherList}" var="teacher">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/Teacher/getTeacher/${teacher.teacherId}" type="button" class="btn btn-sm btn-default">修改</a>
                                                <a href="javascript:deteleTeacher('${teacher.teacherId}')" type="button" class="btn btn-sm  btn-default">删除</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
