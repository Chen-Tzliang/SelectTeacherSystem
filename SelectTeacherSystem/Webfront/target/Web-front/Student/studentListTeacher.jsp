                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active panel panel-default dropdown">
                            ...
                            <div id="dropdown-table" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <ul class="nav navbar-nav">
                                        <li><a href="/Admin/adminAddTeacherAccount.jsp">查看课题</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    ...
                    <div class="description">下面是教师详细信息，你可以查看教师详细信息并返回选课！</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="/Course/studentCourseSelect/<%=session.getAttribute("studentId")%>/"  method="post">
                                    <div class="sub-title">姓名</div>
                                    <div>
                                        <input type="text" class="form-control" disabled id="teacherName" name="teacherName" value="${teacher.teacherName}" >
                                    </div>
                                    ...
                                    <div>
                                        <input type="text" class="form-control"id="teacherAwards" name="teacherAwards" value="${teacher.teacherAwards}" >
                                    </div>
