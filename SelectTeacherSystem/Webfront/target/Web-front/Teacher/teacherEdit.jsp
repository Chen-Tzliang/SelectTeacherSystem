        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    <span class="title">教师信息修改</span>
                    <div class="description">下面是教师的信息，你可以通过键入来修改,修改失败返回首页！</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="/Teacher/teacherUpdateTeacher/${teacher.teacherId}" method="post">
                                    <div class="sub-title">教工号</div>
                                    <div>
                                        <input type="text" class="form-control" disabled id="teacherId" name="teacherId" value="${teacher.teacherId}" >
                                    </div>
                                    ...
                                    <div>
                                        <select name="teacherSex" id="teacherSex">
                                            <option value="男" <c:if test="${'男'==teacher.teacherSex}">selected</c:if>>男</option>
                                                <option value="女"<c:if test="${'女'==teacher.teacherSex}">selected</c:if>>女</option>
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="teacherEmail" name="teacherEmail" value="${teacher.teacherEmail}" >
                                    </div>
                                    <div class="sub-title">地址</div>
                                    <div>
                                        <input type="text" class="form-control"id="teacherAddress" name="teacherAddress" value="${teacher.teacherAddress}" >
                                    </div>
                                    <div class="sub-title">电话</div>
                                    <div>
                                        <input type="text" class="form-control"id="teacherPhone" name="teacherPhone" value="${teacher.teacherPhone}" >
                                    </div>
                                    <div class="sub-title">QQ</div>
                                    <div>
                                        <input type="text" class="form-control" id="teacherQq" name="teacherQq" value="${teacher.teacherQq}" >
                                    </div>

                                    <div class="sub-title">教龄</div>
                                    <div>
                                        <input type="text" class="form-control"id="teacherTeaage" name="teacherTeaage" value="${teacher.teacherTeaage}" >
                                    </div>
                                    <div class="sub-title">获奖信息</div>
                                    <div>
                                        <textarea class="form-control" rows="3"id="teacherAwards" name="teacherAwards" value="${teacher.teacherAwards}"></textarea>
                                    </div>
