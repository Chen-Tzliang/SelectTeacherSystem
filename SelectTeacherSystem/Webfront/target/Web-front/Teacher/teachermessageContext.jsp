        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    ...
                    <div class="description">下面是留言信息</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="sub-title">学生姓名</div>
                                <div>
                                    <input type="text" disabled class="form-control"id="studentName" name="studentName" value="${studentName}" >
                                </div>
                                <div class="sub-title">留言信息</div>
                                <div>
                                    <textarea class="form-control"  rows="7" id="messageContext" name="messageContext" >${messageContext}</textarea>
                                </div>
