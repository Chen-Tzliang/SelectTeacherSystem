...
<div class="app-container">
    <div class="row content-container">
        ...
        <!-- Main Content -->
        <form action="/SelectStudent/addStudentName/<%=session.getAttribute("teacherId")%>" method="post" name="form">
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">学生表</span>
                        <div class="description">这是学生基本信息</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="/SelectStudent/listStudent/${student.studentName}"><u>${student.studentName}</u></a></td>
                                            <td>${student.studentSex}</td>
                                            <td>${student.studentAge}</td>
                                            <td>${student.studentAddress}</td>
                                            <td>${student.studentEmail}</td>
                                            <td>${student.studentPhone}</td>
                                            <td>${student.studentFirst}</td>
                                            <td><input type="checkbox" onclick="Check()" name="studentId" value="${student.studentId}"/></td>
                                        </tr>
                                        </tbody>
                                        </c:forEach>
                                        <input type="text" hidden name="teacherId" value="<%=session.getAttribute("teacherId")%>">
                                    </table>
                                    </c:if>
                                </div>
                            </div>
