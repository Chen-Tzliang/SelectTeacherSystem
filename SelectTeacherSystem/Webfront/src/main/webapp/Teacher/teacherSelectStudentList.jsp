        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    ...
                    <div class="description">以下是你所选择的学生！</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           <a href="/SelectStudent/deleteStudent/${student.studentId}/Id/<%=session.getAttribute("teacherId")%>" type="button" class="btn btn-sm btn-default">删除</a>
                                        </td>
                                    </tr>
