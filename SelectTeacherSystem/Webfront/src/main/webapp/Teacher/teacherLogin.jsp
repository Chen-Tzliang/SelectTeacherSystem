            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom">
                        <form role="form" action="/Teacher/login" method="post" class="login-form">
                            <div class="form-group">
                                <label class="sr-only" for="teacherId">教工号</label>
                                <input type="text" name="teacherId" placeholder="教工号..." class="form-username form-control" id="teacherId">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="teacherPassword">密码</label>
                                <input type="password" name="teacherPassword" placeholder="密码..." class="form-password form-control" id="teacherPassword">
                            </div>
