        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    ...
                    <div class="description">课题表查看所有课题信息</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/Course/getCourse/${course.courseId}" type="button" class="btn btn-sm btn-default">修改</a>
                                            <a href="/Course/deleteCourse1/${course.courseId}" type="button" class="btn btn-sm btn-default">删除</a>
                                        </td>
                                    </tr>
