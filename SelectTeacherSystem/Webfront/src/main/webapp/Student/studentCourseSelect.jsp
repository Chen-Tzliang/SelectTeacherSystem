...
<div class="app-container">
    <div class="row content-container">
        ...
        <!-- Main Content -->
        <form action="/Student/addCourseName" method="post" >
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">课题表</span>
                        <div class="description">通过课题编号和课题教师查看详细信息</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td><a href="/Course/getBycourseId/${course.courseId}/Id/<%=session.getAttribute("studentId")%>"><u>${course.courseId}</u></a></td>
                                            <td>${course.courseName}</td>
                                            <td><a href="/Course/getBycourseTeacher/${course.courseTeachername}/Id/<%=session.getAttribute("studentId")%>"><u>${course.courseTeachername}</u></a></td>
                                            <td>${course.courseApplytime}</td>
                                            <td>${course.courseSum}</td>

                                            <td>
                                                <input type="checkbox" name="studentFirst" value="${course.courseName}"/>
                                            </td>
                                        </tr>
                                        </tbody>
                                        </c:forEach>
                                        <input type="text" hidden name="studentId" value="<%=session.getAttribute("studentId")%>"/>
                                    </table>
                                    </c:if>
                                </div>
                            </div>
