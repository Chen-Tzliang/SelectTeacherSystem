        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    <span class="title">留言表</span>
                    <div class="description">查看所有留言信息</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="/Message/intoMessage/<%=session.getAttribute("studentId")%>/Id/${course.courseTeachername}"><u>进行留言</u></a>
                                            <a href="/Message/updateMessage/<%=session.getAttribute("studentId")%>/Id/${course.courseTeachername}"><u>重新留言</u></a>
                                        </td>
                                    </tr>
