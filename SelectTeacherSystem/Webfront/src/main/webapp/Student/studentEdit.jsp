                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="/Student/studentUpdateStudent/${student.studentId}" method="post">
                                    ...
                                    <div>
                                        <select name="studentSex" id="studentSex" >
                                                <option value="男"<c:if test="${'男'==student.studentSex}">selected</c:if>>男</option>
                                                <option value="女" <c:if test="${'女'==student.studentSex}">selected</c:if>>女</option>
                                        </select>
                                    </div>
