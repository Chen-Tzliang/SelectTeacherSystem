                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="/Message/updateToMessage/<%=session.getAttribute("studentId")%>" method="post">
                                    ...
                                    <input type="text" hidden name="teacherId" value="${message.teacherId}"/>
                                    <input type="text" hidden name="messageId" value="${message.messageId}"/>
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" class="btn btn-default" >重新留言</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
