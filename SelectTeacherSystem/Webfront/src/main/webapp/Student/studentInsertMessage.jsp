        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    <span class="title">学生留言</span>
                    <div class="description">下面请发送留言给老师</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="/Message/insertMessage/<%=session.getAttribute("studentId")%>" method="post">
                                    <div class="sub-title">学号</div>
                                    <div>
                                        <input type="text" class="form-control" disabled id="studentId" name="studentId" value="<%=session.getAttribute("studentId")%>" >
                                    </div>

                                    <div class="sub-title">指导教师姓名</div>
                                    <div>
                                        <input type="text" class="form-control" disabled id="teacherName" name="teacherName" value="${teacherName}" >
                                    </div>

                                    <div class="sub-title">留言</div>
                                    <div>
                                        <textarea class="form-control" rows="7" id="messageContext" name="messageContext" ></textarea>
                                    </div>
                                    <input type="text" hidden name="teacherId" value="${teacherId}"/>
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" class="btn btn-default" >进行留言</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
