        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    ...
                    <div class="description">下面是选课的信息，你可以查看自己的选课情况,可以选择重新选择返回选课！</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="/Course/studentCourseSelectAgain/<%=session.getAttribute("studentId")%>" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" class="btn btn-default" >重新选择</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
