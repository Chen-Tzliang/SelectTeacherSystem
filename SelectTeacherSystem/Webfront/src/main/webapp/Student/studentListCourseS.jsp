        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    <span class="title">课题信息</span>
                    <div class="description">下面是课题详细信息，你可以查看课题详细信息并返回选课！</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="/Course/studentCourseSelect/<%=session.getAttribute("studentId")%>/"  method="post">
                                    <div class="sub-title">课题编号</div>
                                    <div>
                                        <input type="text" class="form-control" disabled id="courseId" name="courseId" value="${course.courseId}" >
                                    </div>
                                    <div class="sub-title">课题姓名</div>
                                    <div>
                                        <input type="text" class="form-control"id="courseName" name="courseName" value="${course.courseName}" >
                                    </div>

                                    <div class="sub-title">指导教师</div>
                                    <div>
                                        <input type="text" class="form-control"id="courseTeachername" name="courseTeachername" value="${course.courseTeachername}" >
                                    </div>
                                    <div class="sub-title">课题来源</div>
                                    <div>
                                        <input type="text" class="form-control" id="courseApplytime" name="courseApplytime" value="${course.courseApplytime}" >
                                    </div>
                                    <div class="sub-title">课题类别</div>
                                    <div>
                                        <input type="text" class="form-control"id="courseSum" name="courseSum" value="${course.courseSum}" >
                                    </div>

                                    <div class="sub-title">详细简介</div>
                                    <div>
                                        <textarea class="form-control" rows="5"id="courseCol" name="courseCol" value="${course.courseCol}"></textarea>
                                    </div>
