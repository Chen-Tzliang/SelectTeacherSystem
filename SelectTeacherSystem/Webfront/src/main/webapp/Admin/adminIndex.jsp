                        ...
                        <ul class="dropdown-menu animated fadeInDown">
                            ...
                            <li>
                                <div class="profile-info">
                                    <h4 class="username">陈紫良</h4>
                                    <p>623965711@qq.com</p>
                                    <div class="btn-group margin-bottom-2x" role="group">
                                        <button type="button" class="btn btn-default"><i class="fa fa-user"></i> 个人信息</button>
                                        <button type="button" class="btn btn-default" onclick="returnLogin()"><i class="fa fa-sign-out"></i> 退出</button>
                                    </div>
                                </div>
                            </li>
                        </ul>
        ...
        <div class="container-fluid">
            <div class="side-body padding-top">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <a href="/Admin/ListTeacherStudent">
