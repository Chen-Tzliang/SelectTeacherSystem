                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="/Teacher/update" method="post">
                                    <div class="sub-title">教工号</div>
                                    <div>
                                        <input type="text" class="form-control" id="teacherId" name="teacherId" value="${teacher.teacherId}" >
                                    </div>
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="teacherPassword"  name="teacherPassword" value="${teacher.teacherPassword}" >
                                    </div>
                                    <div class="sub-title">性别</div>
                                    <div>
                                        <input type="text" class="form-control"id="teacherSex" name="teacherSex" value="${teacher.teacherSex}" >
                                    </div>
                                    <div class="sub-title">年龄</div>
                                    <div>
                                        <input type="text" class="form-control"id="teacherAge" name="teacherAge" value="${teacher.teacherAge}" >
                                    </div>
                                    <div class="sub-title">奖项</div>
                                    <div>
