        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    <span class="title">注册学生信息</span>
                    <div class="description">添加学生</div>
                </div>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="/Student/addStudent" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                                    <input type="text" name="studentName"   class="form-control"   id="studentName" placeholder="输入学生姓名..." onblur="LoginCheck()">
                                            <span id="studentNameCheck" style="color: red; font-size: 15px;"></span>
                                        </div>
                                    </div>
