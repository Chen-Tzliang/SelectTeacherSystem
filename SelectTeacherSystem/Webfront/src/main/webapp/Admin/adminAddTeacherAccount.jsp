        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    <span class="title">注册教师信息</span>
                    <div class="description">添加教师</div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="/Teacher/addTeacher" method="post" id="Register2" >
                                    <div class="form-group">
                                        <label for="teacherName" class="col-sm-2 control-label">教师姓名：</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="teacherName"   class="form-control"   id="teacherName" placeholder="写入教师姓名.." onblur="LoginCheck2()">
                                            <span id="teacherNameCheck" style="..."></span>
                                        </div>
                                    </div>
