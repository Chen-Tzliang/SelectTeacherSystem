        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    ...
                    <div class="description">查看所有学生信息</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table class="datatable table table-striped" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/Student/getStudent/${student.studentId}" type="button" class="btn btn-sm btn-default">修改</a>
                                            <a href="javascript:deteleStudent('${student.studentId}')" type="button" class="btn btn-sm btn-default">删除</a>
                                        </td>
                                    </tr>
                                    </c:forEach>
                                    </tbody>
